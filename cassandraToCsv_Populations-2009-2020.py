...
query_select="SELECT * FROM emissions5.populations2009;"
#CQL_query = query_select.format('All greenhouse gases - (CO2 equivalent)', 'Total (without LULUCF)')
rowsResult = session.execute(query_select)
...
exportDF.columns = ['id','geo_time','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018','2019','2020']
exportDF.head(15)


# Export to CSV format
exportDF.to_csv(r'/home/fitec/export_data-emissions-populations-2009-2020-01.csv', index = False) # place 'r' before the path name to avoid any errors in the path
